...
#Array for storing valid team names. This was a last-minute hack
valid_teams = []
...
#Uncomment to enable team creation. Not really needed
#with valid_teams array
...
#Set up valid team names. This is a last-minute hack
for i in range (1, 32):
